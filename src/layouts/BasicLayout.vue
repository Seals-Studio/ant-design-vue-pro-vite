...
<script>
import { SettingDrawer, updateTheme } from '/src/components/ProLayout/index.js'
import { i18nRender } from '/src/locales'
import { mapState } from 'vuex'
import { CONTENT_WIDTH_TYPE, SIDEBAR_TYPE, TOGGLE_MOBILE_TYPE } from '/src/store/mutation-types'

import defaultSettings from '/src/config/defaultSettings'
import RightContent from '/src/components/GlobalHeader/RightContent'
import GlobalFooter from '/src/components/GlobalFooter'
// import Ads from '/src/components/Other/CarbonAds'
...
export default {
  ...
  data() {
    return {
      ...
      // end
      isDev: import.meta.env.MODE === 'development' || import.meta.env.VITE_APP_PREVIEW === 'true',
