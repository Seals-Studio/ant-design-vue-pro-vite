...
<script>
import { colorList } from '/src/components/SettingDrawer/settingConfig'
import { baseMixin } from '/src/store/app-mixin'
import { NAV_THEME, TOGGLE_NAV_THEME } from '/src/store/mutation-types'
